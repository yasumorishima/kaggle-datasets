...
// Make sure you are on the Column Description edit page
...
(function() {
    ...
    // Column descriptions
    const columns = {
  "pitch_type": "Pitch type abbreviation (FF=Four-Seam Fastball, SL=Slider, CH=Changeup, CU=Curveball, SI=Sinker, FC=Cutter, etc.) - Classified by Statcast",
  "game_date": "Date of the game (YYYY-MM-DD format)",
  "player_name": "Pitcher's full name",
  "player_name_eng": "Pitcher's name in English transliteration",
  "pitcher": "MLBAM player ID of the pitcher (matches 'mlbam_id' in players.csv)",
  "batter": "MLBAM player ID of the batter facing this pitch",
  ...
  "events": "At-bat outcome (e.g., single, strikeout, home_run, walk) - Only on final pitch",
