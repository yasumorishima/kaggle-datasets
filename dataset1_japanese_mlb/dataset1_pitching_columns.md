# Dataset 1: Japanese MLB Pitchers - Column Descriptions

## File: japanese_mlb_pitching.csv
...
### **pitch_type**
```
Pitch type abbreviation (FF=Four-Seam Fastball, SL=Slider, CH=Changeup, CU=Curveball, SI=Sinker, FC=Cutter, etc.) - Classified by Statcast
```
...
### **player_name_eng**
```
Pitcher's name in English transliteration
```

### **pitcher**
```
MLBAM player ID of the pitcher (matches 'mlbam_id' in players.csv)
```

### **batter**
```
MLBAM player ID of the batter facing this pitch
```
...
### **events**
```
At-bat outcome (e.g., single, strikeout, home_run, walk) - Only on final pitch
```
